...
public class EntryServiceUnitTests {
    ...
    void addEntry_Success(){
        ...
        EntryResponse response = entryService.addEntry(mockUser, entryDto);
    ...
    void getAllUserEntries_NoEntries() {
        ...
        List<EntryResponse> responses = entryService.getAllUserEntries(mockUser);
    ...
    void updateEntry_Success() {
        ...
        EntryResponse response = entryService.updateEntry(mockUser, updatedDetails, 1L);
